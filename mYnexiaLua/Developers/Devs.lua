...
function Player.staff(player, str, int)
	local loreTable = {charIDs = {2, 18}, charLevels = {99, 99}}	
	local mapTable = {charIDs = {2, 18}, charLevels = {99, 99}}
	local scriptTable = {charIDs = {2, 18}, charLevels = {99, 99}}
	local projectManagerTable = {charIDs = {2, 18}, charLevels = {99, 99}}
	local accessLevel = -1
