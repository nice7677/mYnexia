...
void do_term(void) {
	...
	printf("mYnexia Char Server Shutdown.\n");
	add_log("Shutdown.\n");
}
...
int do_init(int argc, char **argv) {
	...
	add_log("");
	add_log("mYnexia Char Server Started.\n");
	...
	printf("mYnexia Char Server is \033[1;32mready\033[0m! Listening at %d.\n", char_port);
