...
struct item_data {
	...
	char name[64], yname[64], text[64], buytext[64], real_name[64], commonscript[64];
	...
	int might_req, grace_req, will_req, depositable, exchangeable, droppable, thrown, unique, dodge, parry, block, resist, vregen, mregen, physdeduct, repairable;
...
char* itemdb_commonscript(unsigned int);
