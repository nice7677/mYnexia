...
/*	
	...
	{
		levelExp = (lvl * baseExpPerLevel + (lvl * lvl));
	}
	else if(lvl < 10)
	{
		levelExp = (((lvl*lvl + 1)  * baseExpPerLevel) + (lvl * lvl));
	}
	else if(lvl < 25)
    {
		levelExp = (((lvl*lvl + 2)  * baseExpPerLevel) + (lvl * lvl));
	}
	else if(lvl < 50)
    {
		levelExp = (((lvl*lvl + 3)  * baseExpPerLevel) + (lvl * lvl));
	}
	else if(lvl < 75)
    {
		levelExp = (((lvl*lvl + 4)  * baseExpPerLevel) + (lvl * lvl));
	}
	else if(lvl < 90)
    {
		levelExp = (((lvl*lvl + 5)  * baseExpPerLevel) + (lvl * lvl));
	}
	else//90 - 99
    {
		levelExp = (((lvl*lvl + 6)  * baseExpPerLevel) + (lvl * lvl));
	}
	
	return (levelExp + lvl*lvl);
*/	
